public class GameObject {
    ...
    GameObject(String fname) {
        ...
        //material = new TextureMaterial("Textures/Elon_Musk_head.bmp");
        me = MaterialEnum.PM;
    ...
    void Draw() {
        //GameObject obj = new GameObject("Meshes/Elon_Musk_head.obj");
        //obj.material = new TextureMaterial("Textures/Elon_Musk_head.bmp");
